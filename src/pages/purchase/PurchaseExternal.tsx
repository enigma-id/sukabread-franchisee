...
/**
 * Halaman Pembelian untuk tipe franchise "Mitra" — membuka app order eksternal
 * (VITE_ORDER_URL) lewat iframe, dengan tombol "Buka di Tab Baru".
 */
export function PurchaseExternal() {
  useDocumentMeta(
