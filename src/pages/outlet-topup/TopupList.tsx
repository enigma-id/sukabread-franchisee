...
import { currencyFormat, formatDateTime, getStatusVariant } from "@/utils";
          ...
          <div className='space-y-4'>
            <div className='grid grid-cols-2 gap-4'>
              <div>
                ...
                <p className='text-sm font-mono font-medium text-slate-800 mt-1 text-decoration'>
                  {detail.code}
                </p>
              </div>
              <div>
            ...
            {detail.document_status === "rejected" &&
              ...
              <div className='grid grid-cols-2 gap-3'>
                {detail?.payment ? (
                  <>
                    ...
                    {detail?.document_status !== "approved" &&
                      detail.payment.qr_url && (
                        <div className='flex-1 justify-center bg-white rounded-2xl'>
                          <img
  ...
  const handleDetail = useCallback(
    (row: ContractOutletTopup) => {
      openModal({
        id: "detail-topup",
        content: (
          <DetailModal id={row.id} onClose={() => closeModal("detail-topup")} />
        ),
      });
    },
